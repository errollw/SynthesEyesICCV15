...
\begin{figure}
    \centering
    \includegraphics[width=0.6\columnwidth]{figs/CLNF_300W_experiment.pdf}
...
We used the author's implementation, with their suggested modifications to improve performance: improved eyelid localization with a state-of-the-art CLNF facial landmark detector \cite{baltrusaitis2013constrained}.
