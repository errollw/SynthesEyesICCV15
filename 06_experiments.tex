...
We synthesized our dataset using the same camera setting as UT dataset~\cite{sugano2014learning}, so that the same normalization scheme can be applied to the test data.
