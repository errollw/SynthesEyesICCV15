...
As shown in \autoref{fig:clnf_results_MPII}, our approach ($1.48\textrm{px}$) demonstrates comparable iris-fitting accuracy with EyeTab ($1.44\textrm{px}$), a state-of-the-art specialist algorithm for fitting ellipses to irises.
