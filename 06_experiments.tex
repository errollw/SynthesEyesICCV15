...
% note on the screen: I tried it briefly early on, and it didn't make much of a difference compared to the powerful environment light, also it wasn't clear how bright to make the screen etc. Considering our results for lighting vs very unrealistic lighting on SynthEyes, I doubt we would have evidence for using it anyway at this stage
