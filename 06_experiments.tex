...
\commentY{I will fully update this paragraph, this also contains a discussion about the case using the same number of persons and different light condition.}
