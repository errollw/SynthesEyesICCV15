...
This fine-tuning model achieved better performances on both settings (untargetted $\mu\!=\!11.12^{\circ}$, targetted $\mu\!=\!7.90^{\circ}$).
The performance of the untargetted case significantly outperformed the state-of-the-art result~\cite{zhang15_cvpr} (Wilcoxon signed-rank test  $p\!<\!0.0001$), and indicates a promising way for a future investigation to fill the performance gap.
