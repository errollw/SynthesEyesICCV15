...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figs/gaze_pose_distributions.png}
    \caption{The gaze direction (first row) and head pose (second row) distributions of different datasets: \dataset, MPIIGaze~\cite{zhang15_cvpr}, and UT \cite{sugano2014learning}.}
    \label{fig:head_gaze_distribution}
\end{figure}
