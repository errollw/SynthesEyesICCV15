...
\commentY{This paragraph is discussing about both modeling and rendering, and the contribution of this work in this context is a bit unclear}
\commentE{The idea was that it focussed on the entertainment industry, I tried to clarify this by mentioning ``digital-doubles'' -- what the Disney work is related to}
\commentY{Can you try to rephrase this paragraph again? At least the comment about \cite{berard2014highquality} sounds like more technical difference from this work.}
