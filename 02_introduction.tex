...
Therefore they are important for a range of applications including gaze-based human-computer interaction~\cite{majaranta14_apc}, visual behavior monitoring~\cite{bulling11_pami}, conversational agents~\cite{vertegaal2001eye}, and -- more recently -- collaborative human-computer vision systems~\cite{yun2013studying,papadopoulos2014training,sattar15_cvpr}. 
...
% The eyes and their movements are important for a range of applications including gaze-based human-computer interaction~\cite{majaranta14_apc}, visual behavior monitoring~\cite{bulling11_pami}, and -- more recently -- collaborative human-computer vision systems~\cite{yun2013studying,papadopoulos2014training,sattar15_cvpr}. 
