...
Recent work by \citet{sugano2014learning} demonstrated the benefits of learning-by-synthesis for appearance-based gaze estimation, but employed only fundamental computer graphics techniques for synthesis that did not account for shape changes \commentA{maybe find some better more concrete limitation}.
...
\commentA{are we the first ones to use learning-by-synthesis for eye-region registration? -> contribution}
\commentA{blend shapes? -> contribution}