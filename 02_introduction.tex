...
Our model is not limited to these computer vision tasks per se but potentially applicable to other tasks that require realistic images of eyes, e.g. evaluation of iris-biometrics.
