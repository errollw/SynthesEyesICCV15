...
Therefore they are important for a range of applications including gaze-based human-computer interaction~\cite{majaranta14_apc}, visual behaviour monitoring~\cite{bulling11_pami}, conversational agents~\cite{vertegaal2001eye}, and -- more recently -- collaborative human-computer vision systems~\cite{yun2013studying,papadopoulos2014training,sattar15_cvpr}. 
...
% The eyes and their movements are important for a range of applications including gaze-based human-computer interaction~\cite{majaranta14_apc}, visual behaviour monitoring~\cite{bulling11_pami}, and -- more recently -- collaborative human-computer vision systems~\cite{yun2013studying,papadopoulos2014training,sattar15_cvpr}. 
% Eyes also play a role in communicating social and emotional information \cite{Argyle1965}.
...
For this reason, recent work on learning-by-synthesis for gaze estimation employed only fundamental computer graphics techniques -- rendering low-resolution meshes without modelling illumination changes or accounting for the varying material properties of the face \cite{sugano2014learning}.
%\cite{lu2012head}
