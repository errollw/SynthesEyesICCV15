...
We therefore \emph{retopologized} the face geometry into a more optimal form using a commercial semi-automatic system\footnote{``ZRemesher 2.0 -- Automatic retopology taken to a new level'', Pixologic, 2015}.
%\cite{ZRemesher}.
