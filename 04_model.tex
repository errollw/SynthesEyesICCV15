...
We therefore \emph{retopologized} the face geometry into a more optimal form using a commercial semi-automatic system\footnote{ZBrush ZRemesher 2.0, Pixologic, 2015}.
%\cite{ZRemesher}.
