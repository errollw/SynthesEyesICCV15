...
\begin{figure}
    \centering
    \inlinelabel{a}{\includegraphics[width=0.32\columnwidth]{eye_model}}
    \hfill
    \inlinelabel{b}{\includegraphics[width=0.64\columnwidth]{eye_examples}}
    \par\vspace{-2pt}
    \caption{Our eye model includes the sclera, pupil, iris, and cornea (a) and exhibits realistic variation in both shape (pupillary dilation) and texture (iris color, scleral veins) (b).}
    \label{fig:eye_model}
\end{figure}
