...
We developed a dynamic eye-region model which can be randomly posed to generate fully labeled training images. 
It features a realistic eyeball and face, and can exhibit variations encountered in the real world.
