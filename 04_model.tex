...
We therefore \emph{retopologized} the face geometry into a more optimal form using a commercial semi-automatic system\footnote{Pixologic, ``Zbrush zremesher 2.0 automatic retopology taken to a new level''}.
%\cite{ZRemesher}.
