...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.195\textwidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{Overview of the model preparation process. The original 3D head scans with 1.4 million polygons (a) are first retopologised to 9,000 polygons (b), surface details are stored with displacement maps (c), 3D iris and eyelid landmarks are annotated manually (d). Sample of the resulting rendering (e).}
    \label{fig:process}
\end{figure*}